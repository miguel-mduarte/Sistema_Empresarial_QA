...
function NumberField({
  ...
  step,
  value,
}: { addon?: string; error?: string; hint: string; idPrefix: string; label: string; min?: string; name: string; onChange: EmployeeFormProps["onChange"]; step: string; value: string }) {
...
function CompensationFields({ errors, form, idPrefix = "", onChange }: EmployeeFormProps) {
